  ...
  return (
    <>
      <div className="flex md:order-2">
        ...
        >
          {/* SearchBox's Search Icon Responsive */}
          <svg
            className="size-5"
            aria-hidden="true"
        ...
        <div className="relative hidden md:block">
          ...
          <input
            type="text"
            id="search-navbar"
            className="block rounded-lg border border-gray-300 bg-gray-50 p-2 ps-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
            placeholder="Search..."
          />
        </div>
        <button
